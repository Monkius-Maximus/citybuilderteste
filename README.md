...
Fundação de arquitetura em **C# puro**, **engine-agnostic**, para um jogo 2D isométrico do
tipo *city builder / tycoon* (inspiração: SimCity 4, OpenTTD). A lógica de simulação é
estritamente separada da apresentação, roda headless em um Console Application e foi pensada
para portabilidade futura para **Unity** ou **Godot**.
